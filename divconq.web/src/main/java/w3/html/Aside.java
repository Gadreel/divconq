...
public class Aside extends MixedElement implements ICodeTag {
	...
	public Aside(Object... args) {
		super(args);
	}
	
    public Aside(String id, String cssclass, Object... args) {
    	super(args);
    	this.id = id;
	...
	public void build(WebContext ctx, Object... args) {
	    ...
	    super.build(ctx, "aside", true, extra, args);
	}
}
