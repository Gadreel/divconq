...
public class Span extends MixedElement implements ICodeTag {
	...
	public Span(Object... args) {
		super(args);
	}
	
    public Span(String id, String cssclass, Object... args) {
    	super(args);
    	this.id = id;
	...
	public void build(WebContext ctx, Object... args) {
	    ...
	    super.build(ctx, "span", true, extra, args);
	}
}
