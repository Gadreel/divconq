...
public class THead extends MixedElement implements ICodeTag {
	...
	public THead(Object... args) {
		super(args);
	}
	
    public THead(String id, String cssclass, Object... args) {
    	super(args);
    	this.id = id;
	...
	public void build(WebContext ctx, Object... args) {
	    ...
	    super.build(ctx, "thead", true, extra, args);
	}
}
