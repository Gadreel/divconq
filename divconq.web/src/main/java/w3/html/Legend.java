...
public class Legend extends MixedElement implements ICodeTag {
	...
	public Legend(Object... args) {
		super(args);
	}
	
    public Legend(String id, String cssclass, Object... args) {
    	super(args);
    	this.id = id;
	...
	public void build(Object... args) {
	    ...
	    super.build("legend", true, extra, args);
	}
}
