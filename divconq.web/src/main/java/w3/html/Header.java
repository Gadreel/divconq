...
public class Header extends MixedElement implements ICodeTag {
	...
	public Header(Object... args) {
		super(args);
	}
	
    public Header(String id, String cssclass, Object... args) {
    	super(args);
    	this.id = id;
	...
	public void build(WebContext ctx, Object... args) {
	    ...
	    super.build(ctx, "header", true, extra, args);
	}
}
